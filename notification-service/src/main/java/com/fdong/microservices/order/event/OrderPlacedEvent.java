...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8855664298013404962L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.fdong.microservices.order.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public OrderPlacedEvent(java.lang.String orderNumber, java.lang.String email, java.lang.String firstName, java.lang.String lastName) {
   ...
   */
  public static com.fdong.microservices.order.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.fdong.microservices.order.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.fdong.microservices.order.event.OrderPlacedEvent.Builder newBuilder(com.fdong.microservices.order.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.fdong.microservices.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.fdong.microservices.order.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.fdong.microservices.order.event.OrderPlacedEvent.Builder newBuilder(com.fdong.microservices.order.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.fdong.microservices.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.fdong.microservices.order.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fdong.microservices.order.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fdong.microservices.order.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fdong.microservices.order.event.OrderPlacedEvent.Builder clearLastName() {
      lastName = null;
